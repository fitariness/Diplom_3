...
class TestConstructorNavigation:
    ...
    def test_click_constructor_navigates_to_constructor(self, feed_page, constructor_page):
    ...
    def test_click_order_feed_navigates_to_feed(self, constructor_page, feed_page):
...
class TestIngredientModal:
    ...
    def test_click_ingredient_opens_details_modal(self, constructor_page, ingredient):
    ...
    @pytest.mark.parametrize('ingredient', INGREDIENTS, ids=INGREDIENT_IDS)
    def test_click_close_button_closes_modal(self, constructor_page, ingredient):
...
class TestIngredientCounter:
    ...
    @pytest.mark.parametrize('ingredient', INGREDIENTS, ids=INGREDIENT_IDS)
    def test_drag_ingredient_increases_counter(self, constructor_page, ingredient):
...
class TestPlaceOrder:
    ...
    def test_authorized_user_can_place_order(self, authorized_constructor_page):
        ...
        check_order_modal_opened(authorized_constructor_page)
